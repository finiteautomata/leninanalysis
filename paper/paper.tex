...
\begin{article}
\begin{abstract}
In order to discover how much related to Russian History in nearly 20th century
were Lenin works, we use the information value concept to extract the most important 
words from them. Therefore, we find out how far are them from certain concepts such as
