...
In Top Senses table we can observe that some senses like local\_anesthetic was matched on Whats to be done? as first result. \\
...
$Similarities$ tables shows that, in most of the works, synsets $lion$, $sugar$, $hair$, $car$ and $television\_receiver$ had a lower similarity in most of the works. \\
